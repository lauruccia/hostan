...
class NotificationController extends Controller
{
    ...
    public function create()
    {
        ...
        foreach ($Notifications as $key => $value) {
            $notification_option[$key] = __($value['translation_key']);
        }
        
        // Add translated subjects for the form
        foreach ($Notifications as $key => $value) {
            $Notifications[$key]['translated_subject'] = __($value['subject_translation_key']);
        }
