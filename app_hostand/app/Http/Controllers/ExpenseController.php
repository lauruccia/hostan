...
class ExpenseController extends Controller
{
    ...
    {
        if (\Auth::user()->type == 'super admin'|| \Auth::user()->can('manage expense')) {
...
{
    if (\Auth::user()->type == 'super admin' || \Auth::user()->can('create expense')) {
        ...
        // if (Auth::user()->type == 'super admin') {
            $types = Type::where('type', 'expense')->get()->pluck('title', 'id');
        // } else {
    ...
    {
        if (\Auth::user()->type == 'super admin'|| \Auth::user()->can('show expense')) {
    ...
    {
        if (\Auth::user()->type == 'super admin'|| \Auth::user()->can('edit expense')) {
            $property = Property::where('parent_id', parentId())->get()->pluck('name', 'id');
            $property->prepend(__('Select Property'), '');
            $types = Type::where('parent_id', parentId())->where('type', 'expense')->get()->pluck('title', 'id');
            $types->prepend(__('Select Type'), '');
    ...
    {
        if (\Auth::user()->type == 'super admin'|| \Auth::user()->can('delete expense')) {
            $expense->delete();
