...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6 col-lg-6">
            ...
            {{ Form::select('arrival_type', ['with_arrival' => __('With arrival'), 'without_arrival' => __('Without')], 'with_arrival', ['class' => 'form-control modern-select', 'id' => 'arrival_type']) }}
        </div>
        ...
        <div class="form-group col-md-6 col-lg-6" id="arrival_time_container">
            ...
            {{ Form::datetimeLocal('arrival_time', null, ['class' => 'form-control', 'id' => 'arrival_time']) }}
        </div>
