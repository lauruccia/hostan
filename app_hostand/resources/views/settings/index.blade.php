                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane {{ !empty($activeTab) && $activeTab == 'company_settings' ? ' active show ' : '' }}" id="company_settings" role="tabpanel"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                {{ Form::label('company_sdi_code', __('SDI Code (Codice SDI)'), ['class' => 'form-label']) }}
                                                {{ Form::text('company_sdi_code', $settings['company_sdi_code'] ?? '', ['class' => 'form-control', 'placeholder' => __('Enter SDI code')]) }}
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-6"></div>
