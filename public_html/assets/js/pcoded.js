...
function font_change(name) {
    ...
    var fontLink = document.querySelector('#main-font-link');
    if (fontLink) {
        fontLink.setAttribute('href', srcs);
    }
    
    var bodyElem = document.querySelector('body');
    if (bodyElem) {
        bodyElem.setAttribute('style', 'font-family:"' + name + '", sans-serif');
    }
    
    var control = document.querySelector('.pct-offcanvas');
    if (control) {
        var fontRadio = document.querySelector('#layoutfont' + name);
        if (fontRadio) {
